...
Word Count:         & \bf 370\footnotemark[1] \\
...
\begin{itemize}
  \item TODO: What is the meaning of this encapsulated TLS 1.3 inside QUIC?\\
  \item TODO: Why is UDP smaller than TCP on the left-hand side? \\
  \item TODO: Similarly, Why is "HTTP over QUIC" layer smaller than HTTP/2?\\
\end{itemize}
...
\subsection{Previous Attempts to Improve TCP by Using TCP1.2 [TODO CHECK THE NAME] and SPDY}
[TODO describe SPDY]
