...
\simon{Critique my implementation that my null-encryption does not completely use additional 16 bytes per packet that were used for encryption before hand. I am not sure, but I guess MsQuic reuses these bytes}
