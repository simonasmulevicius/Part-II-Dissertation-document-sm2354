...
To be precise, the testing environment used 10 Gigabit Ethernet links and the end-to-end delay between the client and the server was $0.262 \pm 0.065$ ms (see \S~\ref{physical_setup_subsection}), meaning that the window size was at least $10^{10}*2.62*10^{-4} = 2.62$~Mbytes.
