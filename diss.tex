...
\begin{itemize}
 ...
 % (https://peering.google.com/\#/learn-more/quic, https://ma.ttias.be/googles-quic-protocol-moving-web-tcp-udp/)
  ...
  \item \textbf{Fast \texttt{TLS1.3} handshake}
    ...
    \caption{Comparison of handshakes required to issue \texttt{HTTP} request. Left section demonstrates that traditionally multiple round trip times are required to establish connection to issue \texttt{HTTP} request. Right section of the diagram shows that \texttt{QUIC} on the other hand combines transport and security layer handshakes. This diagram is taken from \cite{the-road-to-quic}.}
