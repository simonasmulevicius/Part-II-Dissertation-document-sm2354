...
It is worth pointing out that small additional packet delay did not significantly reduce \texttt{QUIC} throughput because there was already some latency implicitly added by the testing environment.
