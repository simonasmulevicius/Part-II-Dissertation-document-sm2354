...
\begin{itemize}
    ...
    \item \textbf{Mr Nick Banks}, software developer from \texttt{Microsoft}, is the co-author of \texttt{MsQuic}\footnote{another implementation of QUIC which is used in this project} and he helped with the setup of this particular implementation of \texttt{QUIC};
...
% TODO: describe IP/UDP/QUIC packets
...
As shown in Figure~\ref{fig:QUIC_handshake_vs_TCP-TLS_handshake}, one of the primary innovations of \texttt{QUIC} is that it combines transport and security layer handshakes thus reducing latency of the first \texttt{HTTP} request.
 ...
 % MAYBE TODO: mention possible amplification attacks of QUIC (https://blog.cloudflare.com/the-road-to-quic/) 
  ...
  % [MAYBE TODO: add a source saying that now there are no implementations that support QUIC without embeded security layer].
