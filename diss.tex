...
Word Count:         & \bf 456\footnotemark[1] \\
...
Similarly, UDP layer is smaller than TCP layer because UDP does not provide congestion control. 
...
Similar idea is expressed in the article written by Alessandro Ghedini and Rustam Lalkaka
\cite{HTTP_3_the_past_the_present_and_the_future}.
...
\subsection{TODO: give an oveview of Gianni's paper}
