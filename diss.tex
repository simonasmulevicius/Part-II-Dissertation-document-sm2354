...
\subsection{MTUs}
  ...
  \simon{State that intermediate machine had MTU of 9000 bytes}
...
\subsection{Performance Comparison of \enquote{\textit{Null} encryption} in \texttt{MsQuic} and \texttt{ngtcp2}}
