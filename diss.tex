...
In this chapter, I introduce \texttt{QUIC}, then I give the project's motivation, and I finish the chapter with a brief overview of \texttt{QUIC} performance measurements performed by other scientists.
...
% TODO: use texts from the ideas.txt file and the email sent to overseers
\subsection{High Level Overview of \texttt{QUIC}}
\subsection{Why are performance measurement of \texttt{QUIC} important?}
