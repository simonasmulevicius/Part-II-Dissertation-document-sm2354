...
During the later stages of project development I discovered that an ability to disable encryption of \texttt{QUIC} was already proposed by Nick Banks from \texttt{Microsoft} \cite{banks-quic-disable-encryption-00}.
% TODO:
% \texttt{Microsoft} -> MsQuic
% > smart first secure handshake
% > can turn off crypto for subsequent packets if both ends aggree
