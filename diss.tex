...
[TODO mention that the diagram was taken from Gianni's paper]
    ...
    Results were as follows: the maximum \texttt{UDP} throughput via machine B was 4.11 Gbits/sec and via loopback cables this number was 4.12 Gbits/sec.
...
[TODO: say that I tried this technique and it did not yield any noticeable effects. Probably because the core pinning is already turned on ]
...
[TODO: describe the meaning of colours]

[TODO: mention that I had to enable additional compiler flags to be able to see deeper call frames - before that they were optimised by compiler and some stacks were partially anonymous]
