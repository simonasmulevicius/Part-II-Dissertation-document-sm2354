...
Word Count:         & \bf 300\footnotemark[1] \\
...
% TODO add references !!!!
QUIC is a next-generation transport layer protocol built on top of UDP \cite{chromium_blog_about_quic}.
...
% TODO mention zero RTT handshake
...
% TODO Key features of QUIC:
% https://archive.nanog.org/sites/default/files/meetings/NANOG64/1051/20150603_Rogan_Quic_Next_Generation_v1.pdf
% congestion control
%  loss detection with signaling (using new seq number)
%  loss recovery
% reliability
% multiplexed (streams??)
% Connection migration (https://peering.google.com/#/learn-more/quic)
