...
This folder also contains forked networking stack required to run \texttt{ngtcp2}. 
...
This software stack is spilt into multiple repositories because it is implemented in a modular fashion.
...
I used the original encrypted stack (see Figure~\ref{fig:High_level_directory_structure_of_the_project}) during the development process to compare its behaviour with my implementation.
...
\simon{Mention licenses - can I publish everything?}
