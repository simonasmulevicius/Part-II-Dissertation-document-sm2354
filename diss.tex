...
\subsection{Disadvantages of \texttt{QUIC}} \label{QUIC_disadvantages}

\begin{itemize}
  \item .
  
  [TODO: say that encrypted QUIC traffic would be invisible to the ISPs? https://owmobility.com/why-is-googles-quic-leaving-network-operators-in-the-dark/]
\end{itemize}
