...
Word Count:         & \bf 10885\footnotemark[1] \\
...
\simon{draw a diagram according to this draft}
...
I achieved this by implementing logic that can turn on null encryption on \texttt{ngtcp2}.
    ...
    \caption[Original process of encrypting, transferring and decrypting \texttt{QUIC} packet]{Original process of encrypting (e.g., steps 1 and 2), transferring  (e.g., steps 3) and decrypting (e.g., steps 4 and 5) \texttt{QUIC} packet}
    \label{fig:Cryptographic_procedures_of_quic}
    \end{figure}

\simon{Describe Figure~\ref{fig:Cryptographic_procedures_of_quic}}

\simon{Add another diagram explaining my solution}
