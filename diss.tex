...
Nevertheless, in the \enquote{Future work} chapter the author suggests carrying out performance analysis of \texttt{QUIC} under different simulated network conditions.
...
As shown in Figure~\ref{fig:QUIC_handshake_vs_TCP-TLS_handshake}, one of the primary innovations of \texttt{QUIC} is that it combines transport and security layer handshakes.
 ...
 % MAYBE TODO: mention possible amplification attacks of QUIC (https://blog.cloudflare.com/the-road-to-quic/) 
  ...
  \item % TODO
  [TODO: state that QUIC is implemented in user space rather than kernel space.]
  [TODO: state why companies like user space (https://www.snellman.net/blog/archive/2016-12-01-quic-tou/)]
